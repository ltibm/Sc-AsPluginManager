# Easy Plugin Management Menu For Angelscript
# Installation
```
"plugin"
{
    "name" "As Plugin Manager"
    "script" "as_pluginmanager"
    "concommandns" "lt"
}
```

# Usage
- Type following commands in the chat, **ADMIN_OWNER** access is required,
